      ...
      <div className="max-w-[1440px] w-[100%]  mx-auto md:px-[40px] xl:px-[80px]">
        <div className="relative sm:text-center md:text-left">
          <div className="absolute transform sm:w-[86.11%] md:w-[42%] sm:-translate-x-1/2 sm:left-1/2 md:left-0 md:-translate-x-0 sm:space-y-[2px] md:space-y-[12px] lg:space-y-[20px] sm:top-[106px] md:top-[176px] lg:top-[154px]  xl:top-[209px] left-0  ">
            ...
            <div className="w-[100%]  sm:text-[12px] lg:text-[16px] xl:text-[20px] text-black  md:leading-[15px] lg:leading-[19px] xl:leading-[24px] font-normal">
            ...
            <div className="w-[100%] absolute sm:top-[180px] md:top-[156px] lg:top-[215px] xl:top-[219px]">
              <div className="absolute bg-white sm:hidden md:block md:top-[10px] lg:top-[16px] md:w-[117px] lg:w-[167px] md:h-[31px] lg:h-[51px] border-solid border-[3px] border-black "></div>
              <div className="absolute sm:left-1/2 transform sm:-translate-x-1/2 sm:-translate-x-123 md:left-0 md:translate-x-0 md:left-[-8px] lg:left-[-16px] text-white bg-primary sm:w-[123px] md:w-[117px] lg:w-[167px] sm:h-[39px] md:h-[31px] lg:h-[51px] md:py-[8px] lg:py-[16px] md:px-[20px] lg:px-[32px] md:text-[12px] lg:text-[16px] flex items-center justify-center  ">
                View projects
              </div>
            </div>
          </div>
