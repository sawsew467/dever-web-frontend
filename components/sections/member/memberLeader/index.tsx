    ...
    <article className="max-w-[1440px] mx-[auto] py-[60px] ">
      <div className=" justify-between relative items-end flex w-[100%] h-[auto] border-l-[8px] border-[#FF0000]">
        <div className="w-[100%] ml-[12px] ">
          <h3
            className="mb-[4px] cursor-pointer w-[auto] uppercase text-[#0098FF] xl:leading-[48px] lg:leading-[38px] md:leading-[29px] xl:text-[40px] lg:text-[32px] md:text-[24px] font-[700] h-[48px]  "
          >
            CLUB LEADER MEMBERS
          </h3>
        ...
        <button className="lg:min-w-[93px] lg:h-[35px] md:min-w-[71px] md:h-[29px] lg:px-[16px]  lg:py-[8px] md:py-[6px] md:px-[12px] flex bg-[#D9D9D9AB] rounded-[4px] border-0 gap-[4px] justify-around items-center  ">
          ...
          />
          <p className=" font-[600] lg:text-[16px] md:text-[12px] lg:h-[19px] md:h-[15px] md:mb-[1px] flex items-center ">Filter</p>
        </button>
      </div>
      <ul className=" xl:mt-[28px] md:mt-[40px] xl:gap-y-[40px] md:gap-y-[35px] flex flex-wrap lg:flex-[0_0_30%] justify-between">
        {data.map( (item , key)=> (
          <li key={key} className=" xl:w-[290px] xl:h-[400px] lg:w-[210px] lg:h-[300px] md:w-[146px] md:h-[204px] cursor-pointer  relative">
          <Image
            width={290}
            height={400}
          ...
          <div className="h-[auto] absolute bottom-0 w-[100%]">
            <div className=" flex justify-center flex-wrap content-center  xl:w-[93px] xl:h-[32px] lg:w-[68px] lg:h-[23px] md:w-[47px] md:h-[16px] lg:rounded-tl-[12px] md:rounded-tl-[6px] bg-[#FF7171] absolute right-0 translate-y-[-100%] m-0">
                <p className="xl:h-[19px] lg:h-[17px] md:h-[12px] xl:text-[16px] lg:text-[14px] md:text-[10px] font-[700] text-[#ffffff] " >K17</p>
            </div>
            <div className="w-[100%] xl:p-[20px] lg:p-[14px] md:pt-[5px] md:px-[10px] xl:h-[118px] lg:h-[88px] md:h-[59px] bg-primary lg:rounded-br-[20px]  md:rounded-br-[15px]">
              <div className="flex flex-col h-[100%] xl:gap-[12px] md:gap-[6px]  ">
                ...
                <div className=" h-[auto] xl:text-[14px]  lg:text-[12px] md:text-[8px] xl:leading-[17px] lg:leading-[14.52px] md:leading-[9.6px] flex justify-between items-end ">
                  ...
                  <h3 className="h-[24px] absolute xl:bottom-[20px] lg:bottom-[14px] md:bottom-[10px] xl:right-[20px] lg:right-[14px] md:right-[10px] inline text-[#fff] font-[700] xl:text-[20px] lg:text-[18px] md:text-[16px]">
                    GEN 5
                  </h3>
                </div>
              </div>
