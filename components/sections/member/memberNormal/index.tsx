...
const ListMember = () => {
  ...
  return (
    <article className="max-w-[1440px] mx-[auto] md:pb-[60px]  mobile:pb-[40px]">
      ...
      <ul className=" xl:mt-[28px] md:mt-[40px] mobile:mt-[20px] xl:gap-y-[40px] md:gap-y-[35px] mobile:gap-y-[20px] flex flex-wrap lg:flex-[0_0_30%] justify-between">
        {data.map( (item , key)=> (
          ...
          <div className="h-[auto] absolute bottom-0 w-[100%]">
            <div className=" flex justify-center lg:pt-[3.75px] xl:py-[6px] lg:pb-[2.5px] mobile:py-[2px] xl:w-[93px] lg:w-[68px] h-[auto] md:w-[47px] mobile:w-[32px] lg:rounded-tl-[12px] md:rounded-tl-[6px] mobile:rounded-tl-[4px] bg-[#C69C6D] absolute right-0 translate-y-[-100%] top-0">
