      ...
      <ul className=" xl:mt-[28px] md:mt-[40px] xl:gap-y-[40px] md:gap-y-[35px] flex flex-wrap lg:flex-[0_0_30%] justify-between">
        {data.map( (item , key)=> (
          ...
          <div className="h-[auto] absolute bottom-0 w-[100%]">
            <div className=" flex justify-center flex-wrap content-center  xl:w-[93px] xl:h-[32px] lg:w-[68px] lg:h-[23px] md:w-[47px] md:h-[16px] lg:rounded-tl-[12px] md:rounded-tl-[6px] bg-[#C69C6D] absolute right-0 translate-y-[-100%] m-0">
