...
function Banner() {
  ...
  return (
    ...
    >
      <div 
      className="max-w-[1440px] w-[100%] px-[20px] md:px-[40px] lg:px-[40px] xl:px-[80px] h-[100%] flex justify-center items-center">
        <div className="w-[310px] lg:w-[724px] xl:w-[724px] h-fit flex flex-col justify-center items-center xl:translate-y-[-40px] lg:translate-y-[-37px] md:translate-y-[32px] translate-y-[28px]">
          ...
          >
            ...
            <motion.div 
              ...
              className="w-[120px] h-[5px] bg-[red] absolute top-[50px] xl:top-[54px]"></motion.div>
          </h1>
          <h2
