            ...
            <div className='max-w-[1440px] w-[100%] h-fit py-[60px] px-[80px] flex justify-between relative'>
                ...
                <div className='w-fit h-[610px] flex flex-col items-end text-[16px] font-[400]'> 
                   ...
                   <div className='w-[540px] mt-[28px]'>
                        <p className='text-right leading-[19px]'>Our products are game-changers, revolutionizing industries and enhancing user experiences. With cutting-edge technology and user-centric design, we deliver innovative solutions that surpass expectations and drive positive change. </p>

                        <p className='text-right leading-[19px] mt-[14px]'> With a team of passionate programmers, developers, and designers, we collaborate to bring innovative solutions to life. Our products range from web and mobile applications to software tools and utilities that streamline processes and enhance productivity.</p>
                    </div>

                    <div className='mt-[40px] w-[186px] h-[51px] border-[3px] relative border-black '>
                        <button className='px-[32px] py-[16px] bg-primary absolute text-[#FFFFFF] font-[400] text-[16px] leading-[19px] top-[-19px] right-[-19px]  transition'><p>Explore Projects</p></button>
                    </div>
                    ...
                    <div className='mt-[171px]'>
                        ...
                        <div className='mt-[12px] w-[136px] flex flex-row justify-between'>
                            ...
                            <a href="https://github.com/sawsew467"><Image src={Github} alt='Github'/></a>
